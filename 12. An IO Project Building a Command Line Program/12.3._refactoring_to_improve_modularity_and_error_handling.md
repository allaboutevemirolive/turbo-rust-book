...
We still create the `query` and `file_path` variables in main, but `main` no longer has the responsibility of determining how the command line arguments and variables correspond.
